...
<html lang="es" dir="ltr">
    ...
    <body>
        <div class=".container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <button type="button" class="btn btn-primary" name="button" onclick="window.location='empresa_form.php'">Crear</button>
    ...
    function cargarTabla(datos){
        const TABLA=document.getElementById('tabla-empresa');
        TABLA.innerHTML="";
